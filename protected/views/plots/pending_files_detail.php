            ...
            <table class="table table-striped table-new table-bordered">
				...
				$com_res="Commercial";	
                   ...
                   $opensql  = "SELECT plots.id
								...
								,streets.streets_sorting FROM memberplot memberplot
                                left join plots plots on memberplot.plot_id=plots.id
...
where   size2='".$_GET['size']."' AND com_res='" . $com_res. "' and plots.project_id='" . $_GET['project_id'] . "'and (plots.block_id='".$_GET['block_id']."'|| plots.block_id !='')  and plots.type='file'";
