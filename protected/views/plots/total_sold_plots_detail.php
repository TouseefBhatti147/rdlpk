...
and  isvilla !=1 and atype NOT LIKE'%Against Land%' and type='Plot' and plots.status !=''
UNION ALL
								SELECT
								plots.id
								, plots.street_id
								...
								Left JOIN size_cat  ON (size_cat.id = plots.size2)
where size2='".$_GET['size']."' AND com_res='".$com_res."' and plots.project_id='".$_GET['project_id']."'
and  plots.atype  LIKE '%Against Land%' and plots.status !='' and plots.type='Plot'";
          ...
          <tr>
            <td bgcolor="#FFFFFF">
                ...
                <tr>
                  ...
                  <td colspan="10" align="center" valign="middle" style="border-top:thin; border-top-style:solid; border-right:thin; border-right-style:solid; font-size:14px;  font-weight:bold"><span class="style6">Total Sold Plots</span></td>
