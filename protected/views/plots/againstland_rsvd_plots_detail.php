...
<h3>Against Land Reserved Plots Detail</h3>
...
and  `ctag` LIKE '%Against Land%' and plots.status='' and plots.type='Plot'";	 	
          ...
          <tr>
            <td bgcolor="#FFFFFF">
                ...
                <tr>
                  ...
                  <td colspan="10" align="center" valign="middle" style="border-top:thin; border-top-style:solid; border-right:thin; border-right-style:solid; font-size:14px;  font-weight:bold"><span class="style6">Against Land Reserved Plots</span></td>
