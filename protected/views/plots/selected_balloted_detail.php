...
<h3>Selected Balloted Detail</h3>
...
where size2='".$_GET['size']."' AND com_res='".$com_res."' and plots.project_id='".$_GET['project_id']."' and   isvilla !=1 and atype NOT LIKE'%Against Land%' and type='Plot' and plots.status !='' order by sectors.sectors_sorting ASC,streets.streets_sorting, plots.plot_detail_address ";
          ...
          <tr>
            <td bgcolor="#FFFFFF">
                ...
                <tr>
                  ...
                  <td colspan="10" align="center" valign="middle" style="border-top:thin; border-top-style:solid; border-right:thin; border-right-style:solid; font-size:14px;  font-weight:bold"><span class="style6">Selected/Balloted Plots</span></td>
