...
<head>
    <script type="text/javascript">
        function PrintDiv(id) {
            ...
            myWindow.document.write('<html><head><title>Sold Villas</title>');
...
status !='' and type='Villa' order by sectors.sectors_sorting,streets.streets_sorting,plots.plot_detail_address asc";
          ...
          <tr>
            <td bgcolor="#FFFFFF">
                ...
                <tr>
                  ...
                  <td colspan="10" align="center" valign="middle" style="border-top:thin; border-top-style:solid; border-right:thin; border-right-style:solid; font-size:14px;  font-weight:bold"><span class="style6">Sold Villas</span></td>
