...
<h3>Total Reserved Plots Detail</h3>
...
where size2='".$_GET['size']."' AND com_res='".$com_res."' and plots.project_id='".$_GET['project_id']."'  
and  plots.`ctag` LIKE '%Against Land%' AND plots.status ='' and plots.type = 'Plot' order by sectors.sectors_sorting DESC) 
...
UNION ALL
								...
								Left JOIN size_cat  ON (size_cat.id = plots.size2)
where 
size2='".$_GET['size']."' AND com_res='".$com_res."' and plots.project_id='".$_GET['project_id']."' 
and    plots.ctag LIKE '%HRL Reserved%' AND plots.status = ''and plots.type = 'Plot' order by sectors.sectors_sorting DESC) 
";
          ...
          <tr>
            <td bgcolor="#FFFFFF">
                ...
                <tr>
                  ...
                  <td colspan="10" align="center" valign="middle" style="border-top:thin; border-top-style:solid; border-right:thin; border-right-style:solid; font-size:14px;  font-weight:bold"><span class="style6">Total Reserved Plots</span></td>
