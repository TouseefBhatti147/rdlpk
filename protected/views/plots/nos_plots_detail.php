...
<head>
    <script type="text/javascript">
        function PrintDiv(id) {
            ...
            myWindow.document.write('<html><head><title>PDF Repor</title>');
...
<h3>Total Open Balance Plots Detail</h3>
...
WHERE
    size2='".$_GET['size']."' AND com_res='".$com_res."' and (plots.block_id='".$_GET['block_id']."'|| plots.block_id !='') and plots.project_id='".$_GET['project_id']."' AND type = 'Plot'
    AND plots.id NOT IN(
   SELECT
								plots.id
								FROM
								...
								Left JOIN memberplot  ON (plots.id = memberplot.plot_id)
								Left JOIN size_cat  ON (size_cat.id = plots.size2)
 where size2='".$_GET['size']."' AND com_res='".$com_res."'and (plots.block_id='".$_GET['block_id']."'|| plots.block_id !='') and plots.project_id='".$_GET['project_id']."' and atype LIKE'%Against Land%' and plots.status !=''
) 
    AND plots.id NOT IN(
    SELECT
        plots.id
    ...
    LEFT JOIN size_cat ON(size_cat.id = plots.size2)
    WHERE
        size2='".$_GET['size']."' AND com_res='".$com_res."'and (plots.block_id='".$_GET['block_id']."'|| plots.block_id !='') and plots.project_id='".$_GET['project_id']."' and `ctag` LIKE '%Villas%' AND TYPE = 'Plot'
) AND plots.id NOT IN(
    SELECT
        plots.id
    FROM
    ...
    LEFT JOIN size_cat ON(size_cat.id = plots.size2)
    WHERE
        size2='".$_GET['size']."' AND com_res='".$com_res."'and (plots.block_id='".$_GET['block_id']."'|| plots.block_id !='') and plots.project_id='".$_GET['project_id']."' AND `ctag` NOT LIKE '%Villas%' AND atype NOT LIKE '%Against Land%' AND plots.type = 'Plot' AND plots.status != ''
) AND plots.id NOT IN(
    SELECT
        plots.id
    FROM
    ...
    LEFT JOIN size_cat ON(size_cat.id = plots.size2)
    WHERE
        size2 = '".$_GET['size']."' AND com_res='".$com_res."' and (plots.block_id='".$_GET['block_id']."'|| plots.block_id !='') AND plots.project_id = '".$_GET['project_id']."'and plots.`ctag` LIKE '%Against Land%' 
)
AND plots.id NOT IN(
    SELECT
        plots.id
    ...
    LEFT JOIN size_cat ON(size_cat.id = plots.size2)
    WHERE
        size2 = '".$_GET['size']."' AND com_res='".$com_res."' and (plots.block_id='".$_GET['block_id']."'|| plots.block_id !='') AND plots.project_id = '".$_GET['project_id']."' and plots.ctag = 'HRL Reserved'
) order by sectors.sectors_sorting,streets.streets_sorting,plots.plot_detail_address asc";
          ...
          <tr>
            <td bgcolor="#FFFFFF">
                ...
                <tr>
                  ...
                  <td colspan="10" align="center" valign="middle" style="border-top:thin; border-top-style:solid; border-right:thin; border-right-style:solid; font-size:14px;  font-weight:bold"><span class="style6">Total Open Balance Plots</span></td>
...
WHERE
   ...
   SELECT
								...
								Left JOIN memberplot  ON (plots.id = memberplot.plot_id)
								Left JOIN size_cat  ON (size_cat.id = plots.size2)
 where size2='".$_GET['size']."' AND com_res='".$com_res."' and plots.project_id='".$_GET['project_id']."' and atype LIKE'%Against Land%' and plots.status !=''
) 
    AND plots.id NOT IN(
    SELECT
        plots.id
    ...
    LEFT JOIN size_cat ON(size_cat.id = plots.size2)
    WHERE
        size2='".$_GET['size']."' AND com_res='".$com_res."' and plots.project_id='".$_GET['project_id']."' and `ctag` LIKE '%Villas%' AND TYPE = 'Plot'
) AND plots.id NOT IN(
    SELECT
        plots.id
    FROM
    ...
    LEFT JOIN size_cat ON(size_cat.id = plots.size2)
    WHERE
        size2='".$_GET['size']."' AND com_res='".$com_res."' and plots.project_id='".$_GET['project_id']."' AND `ctag` NOT LIKE '%Villas%' AND atype NOT LIKE '%Against Land%' AND plots.type = 'Plot' AND plots.status != ''
) AND plots.id NOT IN(
    SELECT
        plots.id
    FROM
    ...
    LEFT JOIN size_cat ON(size_cat.id = plots.size2)
    WHERE
        size2 = '".$_GET['size']."' AND com_res = 'Residential' AND plots.project_id = '".$_GET['project_id']."'and plots.`ctag` LIKE '%Against Land%' 
)
AND plots.id NOT IN(
    SELECT
        plots.id
    ...
    LEFT JOIN size_cat ON(size_cat.id = plots.size2)
    WHERE
        size2 = '".$_GET['size']."' AND com_res = 'Residential' AND plots.project_id = '".$_GET['project_id']."' and plots.ctag = 'HRL Reserved'
) order by sectors.sectors_sorting,streets.streets_sorting,plots.plot_detail_address asc";
