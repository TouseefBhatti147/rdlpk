...
<head>
    <script type="text/javascript">
        function PrintDiv(id) {
            ...
            myWindow.document.write('<html><head><title>PDF Report</title>');
...
where size2='".$_GET['size']."' AND com_res='".$com_res."' and plots.project_id='".$_GET['project_id']."' and plots.ctag = 'HRL Reserved' AND plots.status ='' order by sectors.sectors_sorting ASC,streets.streets_sorting, plots.plot_detail_address ASC";
