...
where size2='".$_GET['size']."' AND com_res='".$com_res."' and plots.project_id='".$_GET['project_id']."' and (plots.block_id='".$_GET['block_id']."'|| plots.block_id !='') and type!='file' order by sectors.sectors_sorting ASC,streets.streets_sorting, plots.plot_detail_address ASC";
          ...
          <tr>
            <td bgcolor="#FFFFFF">
                ...
                <tr>
                  ...
                  <td colspan="10" align="center" valign="middle" style="border-top:thin; border-top-style:solid; border-right:thin; border-right-style:solid; font-size:14px;  font-weight:bold"><span class="style6">Total Plots</span></td>
                 ...
                 <td style="padding-left:2px; text-align:left; border-left:thin; border-left-style:solid; border-top:1px solid ; border-top-style:solid; border-right:1px solid; border-right-style:solid;border-bottom:1px solid; border-bottom-style:solid; font-size:12px;">Normal</td>
                	 ...
                	 $connection = Yii::app()->db;
                	  $opensql  = "SELECT
								...
								Left JOIN memberplot  ON (plots.id = memberplot.plot_id)
								Left JOIN size_cat  ON (size_cat.id = plots.size2)
where size2='".$_GET['size']."' AND com_res='".$com_res."' and plots.project_id='".$_GET['project_id']."' and type!='file' order by sectors.sectors_sorting ASC,streets.streets_sorting, plots.plot_detail_address ASC";
