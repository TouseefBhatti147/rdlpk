...
if($row['type']=='file'){echo '<b>File Size &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  :&nbsp;</b>';}else {echo '<b>Plot Size &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;</b>';}
  echo $row['size'].'&nbsp;('.$row['plot_size'].')'.'</br>';
		...
		if($row['stst']==2){ echo'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:red">Blocked</span>';}else{
		   if($row['is_property']==1){ echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>:</b>&nbsp;'.$row['plot_detail_address'].'/'.$row['building_name'].'/'.$row['floor_name'].'</br>';
		   }else{
...
foreach($landcost as $land){
		...
		if($land['surcharge_re']==0){$surch=$surch+floatval($land['surcharge']);}
...
$new_date = date('d-m-Y', $middle);
	 ...
	 $paid_date_temp = date('d-m-Y', $paid_date_temp);
		...
		$bsur=$row['amount']-floatval($row['paidamount']);
 ...
 <td style="text-align:right;">'.number_format($bsur-$row['discount']).'</td>
  ...
  <td>';
  if(($row['paid_date_temp'] == '0000-00-00')|| $paid_date_temp == NULL){ echo'';}else{ echo ($paid_date_temp);}
  echo'</td>
...
$new_date = date('d-m-Y', $middle); 
	echo '<p style="margin:none;"><b>Project</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;' .$row['project_name'].'</p>';
		 echo '<p style="margin:none;"><b>Type</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;' .$row['com_res'].'/111'.$row['type'].'&nbsp;'; 
	if($row['com_res']=='Residential'){
		if($row['isvilla']==1){
		 echo'Villa';}else{ echo'Plot';
		 }}
