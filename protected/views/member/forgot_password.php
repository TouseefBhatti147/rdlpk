...
<h3 class="green bolder  inline">Forgot Password</h4>
</div>
<hr class="hr-4">
<div class="center">
<h5 class="blue bolder">Request to reset forgot password </h5>
 </div>
 <div class="social-or-login center">
						<span class="bigger-110"> Enter your detail and Proceed</span>
					</div>
<hr class="hr-4">
