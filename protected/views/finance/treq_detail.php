...
<?php }?>
  ...
  <h5 style="text-align:left;">Action History</h5>
<table class="table table-striped table-new table-bordered">
 <tbody><?php $old = $key['sc_date']; $mid = strtotime($old); $new = date('d-m-y', $mid); ?>
 <?php $adate = $key['admin_date']; $amid = strtotime($adate); $anew = date('d-m-y', $amid); ?>

<tr><td>	Transfer Request Date</td><td><strong><?php echo $new; ?></strong></</td></tr>
<tr><td>	 Sales Center Status :</td><td><strong><?php if($key['sc_status']=='Approved'){ echo '<span style="color:green">'.$key['sc_status'];echo'</span>';}else{echo '<span style="color:orange">'.$key['sc_status'];echo'</span>'; }?></strong></td></tr>
<tr><td>    Sales Center Comments:    </td><td><?php echo $key['sc_comment']?></td></tr>
<tr><td>    Sales Center User:    </td><td><strong><?php echo $key['sc_user'];?></strong></td></tr>

<tr><td>	Head Office Approval Date</td><td><strong><?php echo $anew; ?></strong></</td></tr>

<tr><td>	 Head Office Status :</td><td><strong><?php if($key['admin_status']=='Approved'){ echo '<span style="color:green">'.$key['admin_status'];echo'</span>';}else{echo '<span style="color:orange">'.$key['admin_status'];echo'</span>'; }?></strong></td></tr>
<tr><td>    Head Office Center Comments:    </td><td><?php echo $key['admin_comment']?></td></tr>
<tr><td>    Head Office User:    </td><td><strong><?php echo $key['admin_user']?></strong></td></tr>
...
$ndis=0;
	...
	{	
     ...
     $due_date_temp1  = strtotime($row['due_date_temp']); 
	 $due_date_temp1 = date('d-m-Y', $due_date_temp1);
	 $paid_date_temp1 = strtotime($row['paid_date_temp']); 
  ...
  echo '</tr><td>'.$row['payment_type'].'</td>
     <td>';if(($due_date_temp1==null) || ($due_date_temp1=='') || ($due_date_temp1 == '30-11--0001' )) { echo''; } else{ echo $due_date_temp1;}echo'</td>
	 <td>';if($paid_date_temp1=='' || $paid_date_temp1==NULL ){ echo'';}else{echo $paid_date_temp1;} echo'</td>
...
$i++;
  ...
  echo '<tr> <td rowspan="'.$co1.'">'.$pay['lab']. '</td>
     <td rowspan="'.$co1.'">';if(($due_date_temp==null) || ($due_date_temp=='') || ($due_date_temp == '30-11--0001' )) { echo''; } else{ echo $due_date_temp;}echo'</td>
     <td>';if(($paid_date_temp==null) || ($paid_date_temp=='') || ($paid_date_temp == '30-11--0001' )) { echo''; } else{ echo $paid_date_temp;}echo'</td>
     <td rowspan="'.$co1.'" style="text-align:right">'.$pay['dueamount'].'</td>
     <td style="text-align:right">'.$pay['paidamount'].'</td>
     <td>'.$pay['payment_type'].'</td>
     <td>'.$pay['detail'].'</td>
	...
	echo '<tr>
     ...
     <td ">'.$pay['lab']. '</td>
     <td ">'.$due_date_temp1.'</td>
     <td>'.$paid_date_temp1.'</td>
     <td rowspan="'.$co1.'" style="text-align:right">'.$pay['dueamount'].'</td>
     <td style="text-align:right">'.$pay['paidamount'].'</td>
     <td>'.$pay['payment_type'].'</td>
     <td>'.$pay['detail'].'</td>
    ...
    <div class="new-box-01">
      ...
      <input type="text" name="plotno" value="'.$result_details3['tempms'].'" id="plotno" style="width:250px;">
        ...
        <input type="text" name="transferdate" value="'.$result_details3['create_date'].'" id="transferdate" style="width:250px;">
         <input type="hidden" name="achid" value="'.$key['achid'].'" id="achid" style="width:250px;">
