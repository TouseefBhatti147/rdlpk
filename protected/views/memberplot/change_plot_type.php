...
<div id="error-div" class="errorMessage" style="display: none; color:#F00;"></div>
 ...
 <input type="text" name="project" readonly="readonly" id="project" value="<?php echo $key['project_name']?>" />
    ...
    <div class="float-left">
      <p class="reg-left-text">MS #<font color="#FF0000">*</font></p>
      <input type="text" value="<?php echo $key['plotno']?>" readonly="readonly()" name="plotno" id="plotno" class="reg-login-text-field" /> 
</div>
    <div class="float-left">
...
<div class="float-left">
  ...
  <div class="float-left">
    <p class="reg-left-text">Plot Type<font color="#FF0000">*</font></p>
    <p class="reg-right-field-area margin-left-5">
   <select name="type" id="type">
   <?php echo"<option value='".$key['type']."'>".$key['type']."</option>";?>
