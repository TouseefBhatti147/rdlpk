...
echo '<tr><td>' . $i . '</td>
 ...
 <td style="text-align:right;">'.number_format($dis).'</td>
  ...
  <td>'.number_format($tpayed).'</td>
   <td><a href="installment_details?id='.$_REQUEST['id'].'&& pid='.$_REQUEST['id'].'">Detail</a>/</td>
</tr></tbody></table>  ';
...
$paidsurcharge=$paidsurcharge+$paidsurch;
?><br />
<img  src="<?php echo Yii::getPathOfAlias('webroot')."/images/cancelled-stamp.png";  ?>" height="150px">
