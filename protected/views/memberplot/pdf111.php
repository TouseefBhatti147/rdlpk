...
<strong><?php echo  date('M d,Y'); ?>
       ...
       <div style=" margin:170px 10 0 0px; position:absolute; width:60%;"><?php  echo $member['address']; 	 ?><br/><?php  echo $member['phone']; 	 ?></div><br/><br/>
   <div style=" margin:170px 10 0 0px; position:absolute;"><br/> Information:Site Office</div>
   <br />
   <div style=" margin:200px 10 0 0px; position:absolute;">Through:<strong> <?php echo 'Mr &nbsp;'.$member['landowner'];?></strong> </div>
	<br/><br/><br/><br/> <br/><br/> <div style=" margin:170px 10 0 0px; position:absolute;"> <strong>Subject:&nbsp; <u>Membership – <?php echo $member['project_name'];?></strong><u>
     </div> 
     <div style=" margin:200px 10 0 0px; position:absolute;">Registraion/ Transfer form no <?php echo $member['app_no'];?> refers
     </div> 
        <p  style=" margin:235px 10 0 0px; position:absolute;">The Management of <strong>Royal Orchard Multan</strong> is pleased to welcome you, on becoming the member of this prestiogious Project. We are determined to provide Residential plot within the stipulated time frame.</p>
        
	<p  style=" margin:280px 0px 0 0px; position:absolute;">You have been allotted Membership no <strong><?php echo $member['plotno'];?></strong>, towards provisional allotment of <strong><?php echo $member['com_res'];?></strong> file of <strong><?php echo $member['plot_size'];?></strong> in <strong><?php echo $member['project_name'].'&nbsp;';if($member['atype']=='Against Land') {echo'( Against Land)';}echo '';?></strong></</strong> vide the agreement executed 
    between <strong><?php echo 'Mr &nbsp;'.$member['landowner'];?> & Royal Developers & Builders (Pvt) Ltd</strong>. In future this Membership no will be used as a reference.</p>
    <br /><p  style=" margin:350px 10 0 0px; position:absolute;">Membership Performa is attached for an early return duly filled at under mentioned address.</p>
    <br /><p  style=" margin:370px 10 0 22px; position:absolute;"><strong>Silver Square Plaza <br/>
    		Plot No 15, F-11 Markaz,<br/>
            Islamabad
    </strong></p>
    <br /><br /><p  style=" margin:410px 10 0 0px; position:absolute;">Thanking you and assuring you our best services, at all times.</p>
    <br /><p  style=" margin:425px 10 0 0px; position:absolute;">With profound regards, <br /> <br /><br /> <br /><br /> <br /><strong>Secretary <br />Royal Orchard</strong></p>
...
<div style="text-align: left; margin-top: 1em;">
  <button type="submit">Membership Letter (Against Land)</button>
</div>
</form></td>
</tr>
    <tr>
...
<div id="email" style="margin:710px 0 0 540px; position:absolute;"><?php echo $member['plot_size']; 	 ?></div>
