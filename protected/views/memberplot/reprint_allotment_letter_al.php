...
<div class="shadow">
  <h3>Reprint Request For Allotment Letter (A/L)</h3>
</div>
...
<div class="float-left" >
  ...
  <select name="allotment_letter_al" id="allotment_letter_al">
    <option value="allotment_letter_al">Allotment Letter (A/L)</option>
  </select>
</p>
</div>
<div class="float-left">
...
<div class="float-left">
  <?php echo CHtml::ajaxSubmitButton(                         'Send Request',
    array('reprint_allotmentletteral'),
                                array(  
                'beforeSend' => 'function(){ 
