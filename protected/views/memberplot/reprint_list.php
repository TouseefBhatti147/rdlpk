...
<select name="project_id" id="project_id" style="width:180px;"><?php	
    ...
    <option value="ms_letter">MS Letter</option>
 
    <option value="allotment_certificate">Allotment Certificate</option>
    <option value="allotment_letter">Allotment Letter</option>
    <option value="ndc_letter">NDC Letter</option>
    <option value="transfer_letter">Transfer Letter</option>
    <option value="transfer_slip">Transfer Slip</option>
    <option value="balloting_detail">Balloting Detail</option>
