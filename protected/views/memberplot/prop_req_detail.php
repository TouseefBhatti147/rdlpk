...
<div class="span6 left-box">
  ...
  <div class="">
    ...
    <input type="hidden" value='.$key['id'].' name="plot_id" id="plot_id" class="f-left span4 clearfix" /> <input type="hidden" value="'.$key['member_id'].'" name="member_id" id="member_id" class="f-left span4 clearfix" />
  	...
  	<div class="black-bg">Plot Address:</div><div class="grey-bg"><input type="text" style="height:16px;" name="street" id="street" readonly=readonly() value="'.$key['building_name'].'/'.$key['floor_name'].'"></div>
...
$new_date = date('d-m-Y', $middle); 
   ...
   <div class="clearfix"></div>
    ...
    <div class="black-bg">Cost Of Plot:</div><div class="grey-bg"><?php echo $result_details2['price'];  ?></div><br>
     <div class="black-bg">Discount:</div><div class="grey-bg"><?php if(!empty($result_dets1['discount'])) { echo $result_dets1['discount']; } ?></div><br>
      <div class="black-bg">Details:</div><div class="grey-bg"><?php if(!empty($result_dets1['details'])) { echo $result_dets1['details']; } ?></div><br>
    </div>
	<div class="span5 left-box">
...
<div class="span5 left-box">
  ...
  <div class="span5 left-box">
    ...
    <div class="grey-bg"> <a href="<?php echo $this->createAbsoluteUrl('memberplot/prop_payment_details?id='.$key['id'].'')?>">Payment Detail Link</a></div>
    <br>
  </div>
