...
<a href="newballott" class="btn btn-success">Create New Balloting</a>
<div class="">          
	...
	';
            echo '<tr><td>'.$key['id'].'</td><td>'.$key['project_name'].'</td>';?><?php echo '<td>'.$key['status'].'</td><td>'.$key['createdate'].'</td><td>'.$key['ddate'].'</td><td><a href="edit_ballott?bid='.$key['id'].'">Edit</a>/<a Onclick="return ConfirmDelete();" href="delete_ballott?bid='.$key['id'].'&pid='.$key['project'].'">Delete</a></td><td><a href="Plotsballot?pid='.$key['project'].'&size='.$key['size'].'&bid='.$key['id'].'">Plots Data</a></td>
			<td><a href="Filesballot?pid='.$key['project'].'&size='.$key['size'].'&bid='.$key['id'].'">Files Data</a></td><td>';
