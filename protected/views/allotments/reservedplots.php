...
<script>	
 ...
 $.ajax({
	     url:"https://<?php echo $address ?>/index.php/plots/Searchballotableres",
                  type:"POST",
...
<div class="shadow">
  ...
  <h3>Reserved Balloting Data<?php if((Yii::app()->session['user_array']['per2']=='1')&& isset(Yii::app()->session['user_array']['username']))
{?>
<?php }?></h3>
</div>
<!-- shadow -->
...
<span style="float:right"><a href="Reserveddata?project_id=<?php echo $_GET['pid'];?>&sector=<?php echo $_GET['sector'];?>">Generate Reserved Balloting Data</a></span>
...
<select id="balloting_status" name="balloting_status" class="new-input">
 ...
 <?php echo CHtml::ajaxSubmitButton(
                                'Search',
     array('/allotments/Searchballotableres/?page=1'),
                                array(  
                'beforeSend' => 'function(){ 
