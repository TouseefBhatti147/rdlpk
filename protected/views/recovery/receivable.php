...
<script>	
 ...
 $.ajax({
	     url:"http://<?php echo $address ?>/index.php/recovery/search_receivable_ajax1",
                  type:"POST",
    ...
    <table class="table table-striped table-new table-bordered" style="font-size:11px;">
      <thead style="background:#666; border-color:#ccc; color:#fff;">
        <tr>
          ...
          <th width="4%">Extra Land Price </th>
          ...
          <th width="4%">Net Balance</th>
           <th width="4%">Balance %</th>
            <th width="4%">Booking Date</th>
          <th width="4%">Entry Date</th>
           <th width="4%">Status </th>
           <th width="4%">Allotment </th>
           <th width="4%">Dealer </th>
