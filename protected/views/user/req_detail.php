...
<tr><td>	Finane Department Status :</td><td><strong><?php if($key['finance_status']=='Approved'){ echo '<span style="color:green">'.$key['finance_status'];echo'</span>';}else{echo '<span style="color:orange">'.$key['finance_status'];echo'</span>'; }?></strong></td></tr>
<tr><td>    Finane Department Comments:    </td><td><?php echo $key['finance_comment']?></td></tr>
<tr><td>    Finane Department User:    </td><td><strong><?php echo $key['finance_user']?></strong></td></tr>
