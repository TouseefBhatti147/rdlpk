...
<div class="container-fluid"> 
 ...
 <li><a href="<?php echo $this->createAbsoluteUrl('plots/plots')?>" class="link-2" title="Plot">Plot/Villa</a></li>
  ...
  <li><a href="<?php echo $this->createAbsoluteUrl('allotments/reslist?pid=1')?>" class="link-2" title="Plot">Search Balloting</a></li>
            ...
            <li><a href="<?php echo $this->createAbsoluteUrl('memberplot/member_prop_lis')?>" class="link-2" title="Member Plot">Member Property</a></li>
            ...
            <li><a href="<?php echo $this->createAbsoluteUrl('property/property_list')?>" class="link-2" title="File">Property</a></li>
        ...
        <li><a href="#" class="link-2" title="Search">Search</a>
          <ul class="sub-menu">
            ...
            <li><a href="<?php echo $this->createAbsoluteUrl('memberplotsales/member_prop_lis')?>" class="link-2" title="Member Plot">Member Property</a></li>
...
'links'=>$this->breadcrumbs,
  ...
  <div class="my-footer">
    <div class="row-fluid my-wrapper">
      ...
      <a href="http://www.hrlpk.com/">  Designed by HRL eSolutions.</a> </div>
    </div>
  </div>
